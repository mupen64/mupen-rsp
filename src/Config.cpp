...
{0, pcit_bool, L"Audio HLE", L"Whether audio lists are processed externally", 0, nullptr, &g_config_readonly, &default_config.audio_hle},
{0, pcit_bool, L"Graphics HLE", L"Whether display lists are processed externally", 0, nullptr, &g_config_readonly, &default_config.graphics_hle},
{0, pcit_bool, L"Audio External", L"Whether audio lists are processed by the audio plugin specified by 'Audio Path'", 0, nullptr, &g_config_readonly, &default_config.audio_external},
{0, pcit_path, L"Audio Path", L"Path to the external audio plugin path for alist processing", 0, nullptr, &g_config_readonly, default_config.audio_path},
{0, pcit_bool, L"Ucode Cache Verify", L"Verify the cached ucode function on every audio ucode task. Enable this if you are debugging dynamic ucode changes.", 0, nullptr, &g_config_readonly, &default_config.ucode_cache_verify},
};
